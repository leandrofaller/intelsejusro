$(document).ready(function () {
    ...
    $('a[name=btnConcluir]').click(function(){
        $('#id').val($(this).closest('tr').find('td[data-id]').data('id'));
        $('#numeropad').val($(this).closest('tr').find('td[data-numeropad]').data('numeropad'));
        $('#datainiciopad').val($(this).closest('tr').find('td[data-datainiciopad]').data('datainiciopad'));
        $('#descricaopad').val($(this).closest('tr').find('td[data-descricaopad]').data('descricaopad'));

        $('#numerorelatorioseguranca').val($(this).closest('tr').find('td[data-numerorelatorioseguranca]').data('numerorelatorioseguranca'));
        $('#tipofato').val($(this).closest('tr').find('td[data-tipofato]').data('tipofato'));
        $('#tipofalta').val($(this).closest('tr').find('td[data-tipofalta]').data('tipofalta'));

        $('#idPad').val($(this).closest('tr').find('td[data-id]').data('id'));
