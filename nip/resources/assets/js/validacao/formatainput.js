$(document).ready(function () {
    ...
    $("input[type=text]").each(function () {
        ...
        if($(this).hasClass('soddd') == true   )
        {
            $(this).attr('placeholder', 'Digite o CPF');
            $(this).mask('(99)');
        }

        if($(this).hasClass('sotelefone') == true   )
        {
            $(this).attr('placeholder', 'Digite o CPF');
        ...
        if($(this).hasClass('hora') == true   )
        {
            $(this).attr('placeholder', 'Hora');
            $(this).mask('99:99');
        }
        ...
        if($(this).hasClass('cnpj') == true   )
        {
            $(this).attr('placeholder', 'Digite o CNPJ');
