        ...
        <div class="row">
            <div class="col-md-12">
                <div  style="width: 350px;">
                    {!!Form::open ( ['route'=>'visitas.mostrarapenados','method' => 'GET','id'=>'formulario'] ) !!}
                        ...
                        <thead>
                            ...
                            @forelse($apenados as $apenado)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if( $status  == 'Apenado Preso' )
                                        <a href="{{ route('visitas.mostrarvisitantes', ['id'=>$apenado->id]) }}" class="btn btn-xs btn-info" title="Incluir Visitante" > <i class="ace-icon fa fa-plus-square
 bigger-120"></i> </a>
                                        @endif
                                    </td>
                                </tr>
