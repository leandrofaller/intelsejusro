            ...
            <div class="widget-box widget-color-dark">
                ...
                <div class="widget-body">
                    <div class="widget-main no-padding">
                        {{ Form::open( ['method' => 'get', 'route' =>  ['relatorios.movimentacoesUnidade'], 'id'=>'formulario' ]) }}
                           <fieldset>
                        ...
                        @forelse($presos as $preso)
                            <tr>
                                ...
                                <th>{!! Request::input('tipo') == 'Entradas'
                                        ...
                                        : \App\Model\Unidade::mostraNomeUnidade($preso->unidadedestino)
                                    !!}
                                    @if( ($preso->unidadeorigem == NULL) and ($preso->unidadedestino == NULL) )
                                       {!!  \App\Model\Unidade::mostraNomeUnidade($preso->unidade_id)  !!}
                                    @endif
                                </th>
                                ...
                                <td>{!! $preso->oficioentrada ? $preso->oficioentrada : '' !!}</td>
                            </tr>
