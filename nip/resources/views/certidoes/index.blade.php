        ...
        <div class="row">
            <div class="col-md-12">
                <div  style="width: 350px;">
                    {!!Form::open ( ['route'=>'certidoes.index','method' => 'GET','id'=>'formulario'] ) !!}
                            ...
                            <tbody>
                                ...
                                @forelse($apenados as $apenado)
                                    ...
                                    <tr>
                                        ...
                                        <td>{!! $legenda !!}</td>
                                        <td>
                                            <a href="{{ route('certidoes.mostradados', ['id'=>$apenado->id]) }}" class="btn btn-xs btn-info" title="Emitir Certidão" > <i class="ace-icon fa fa-plus-square
     bigger-120"></i> </a>
                                        </td>
                                    </tr>
                                @empty
