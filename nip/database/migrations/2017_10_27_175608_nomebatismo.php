...
class Nomebatismo extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('nomebatismo', function (Blueprint $table) {
            $table->increments('id');
            $table->integer('nome_batismo')->unsigned();
            $table->string('atual_batismo');
    ...
    {
        Schema::dropIfExists('nomebatismo');
    }
}
