...
class PadrinhosExternos extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('padrinhosexterno', function (Blueprint $table) {
            $table->increments('id');
            $table->string('nome_padrinhoexterno');
            $table->string('descricao_padrinhoexterno');
    ...
    {
        Schema::dropIfExists('padrinhosexterno');
