...
class Localbatismo extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('localbatismo', function (Blueprint $table) {
            $table->increments('id');
            $table->integer('nome_localbatismo')->unsigned();
            $table->string('atual_localbatismo');
    ...
    {
        Schema::dropIfExists('localbatismo');
