...
class Quebradaatual extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('quebradaatual', function (Blueprint $table) {
            $table->increments('id');
            $table->integer('nome_atual')->unsigned();
            $table->string('atual_atual');
    ...
    {
        Schema::dropIfExists('quebradaatual');
