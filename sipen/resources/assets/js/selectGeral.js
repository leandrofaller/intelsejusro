...
$(document).ready(function(){
   ...
   $('#unidade_id').on('change', function(e){
        ...
        $.get('https://intelsejusro.com/sipen/carceragem-sub?unid_id=' + unid_id, function(data) {
            $('#carceragem_id').empty();
            $('#cela_id').empty();
    ...
    $('#carceragem_id').on('change', function(e){
        ...
        $.get('https://intelsejusro.com/sipen/celas-sub?carc_id=' + carc_id, function(data) {
            $('#cela_id').empty();
    ...
    $('#possivel').on('change', function(e){
        ...
        $.get('https://intelsejusro.com/sipen/classificacao?class_id=' + id, function(data) {
            $('#classificacao').empty();
            $.each(data, function(index,subCelaObj){
    ...
    $('#faccao_id').change(function () {
        ...
        $.ajax({
              url: 'https://intelsejusro.com/sipen/cargo-sub/'+fac_id,
    ...
    $('#faccao_id').change(function () {
        ...
        $.ajax({
              url: 'https://intelsejusro.com/sipen/padrinhos-sub/'+fac_id,
