<div class="modal fade" id="myModalFicha" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-lg " role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title">SELECIONE OS MÓDULOS PARA IMPRESSÃO NA FICHA PRISIONAL</h4>
            </div>

            {!! Form::open(['route'=>['relatorios.fichaGeral'] , 'target'=>'_blanck' ]) !!}
...
{{--<BR>--}}
                                    ...
                                    <div class="checkbox">
                                        <label class="block">
                                            ...
                                            <span class="lbl bigger-120"> INFORMAÇÕES ADICIONAIS</span>
                                        </label>
                                    </div>
                                </div>
