        ...
        <div class="row">
            <div class="col-md-12">
                <div  style="width: 350px;">
                    {!!Form::open ( ['route'=>'faccaointegrantes.index','method' => 'GET','id'=>'formulario'] ) !!}
                        ...
                        @forelse($apenados as $apenado)
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>{!! $legenda !!}</td>
                                    <td>
                                        @if(Integrantes::mostraFaccao($apenado->id) != '' )
                                            <span class="label label-sm label-warning"> {!! Integrantes::mostraFaccao($apenado->id) !!}  </span>
                                        @endif
                                    </td>
                                   ...
                                   {{-- @if( $status  == 'Apenado Preso' ) --}}
                                       @if(Integrantes::mostraFaccao($apenado->id) == '' )
                                            <a href="{{ route('faccaointegrantes.incluir', ['id'=>$apenado->id]) }}" class="btn btn-xs btn-info" title="Incluir Faccão" >
