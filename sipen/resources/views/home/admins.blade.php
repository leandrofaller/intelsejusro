...
{{--<div id="gritter-notice-wrapper">--}}
        {{--<div id="gritter-item-5" class="gritter-item-wrapper gritter-info">--}}
                {{--<div class="gritter-top"></div>--}}
            {{--<div class="gritter-item">--}}
                {{--<div class="gritter-close" style="display: none;"></div>--}}
                {{--<div class="gritter-with-image">--}}
                    {{--<span class="gritter-title">Atenção!!!</span>--}}
                    {{--<p>Mensagem Aqui. em desenvolvimento</p>--}}
                {{--</div>--}}
...
{{--<a href="{{route('relatorios.recebimentoGeral') }}">--}}
    {{--<div class="infobox infobox-orange">--}}
        {{--<div class="infobox-icon"> <i class="ace-icon fa fa-arrow-circle-right"></i> </div>--}}
        {{--<div class="infobox-data">--}}
            {{--<span class="infobox-data-number"> {!! empty($recebimento) ? '0' : count($recebimento) !!}  </span>--}}
...
{{--<div class="infobox infobox-red">--}}
    ...
    {{--<div class="infobox-data">--}}
        {{--<span class="infobox-data-number"> {!! empty($fugas) ? '0' : count($fugas) !!}  </span>--}}
...
{{--<a href="{!! route('mapa.index') !!}" class="btn btn-success">   <i class="ace-icon fa fa-street-view"></i> Abrir Mapa de Unidades</a>--}}
        ...
        <div class="widget-box widget-color-blue2">
            <div class="widget-header widget-header-flat">
                <h4 class="widget-title lighter">
                    ...
                    Presos por Unidades Prisionais
                </h4>
