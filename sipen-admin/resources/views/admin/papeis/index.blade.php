...
@section('main')
    ...
    <div class="row">
        <div class="col-md-6">
            <h2><i class="fa fa-puzzle-piece text-muted"></i> {{ $title }}</h2>
        </div>
        <div class="col-md-6">
            <br>
            ...
            <div class="form-group">
                <div class="input-group">
                    ...
                    {{ Form::text('q', Request::get('q'), ['autofocus', 'class' => 'form-control', 'placeholder' => 'Procure por nome do sistema ou papel']) }}
                    <div class="input-group-btn">
                ...
                <div class="table table-responsive">
                    <table class="table table-bordered table-condensed table-striped table-hover">
                        ...
                        @forelse($papeis as $papel)
                            <tr>
                                <td>
                                    <a href="{{ route('sistemas.edit', $papel->app_id) }}">{{ $papel->sistema->name }}</a>
                                </td>
                                <td>{{ $papel->name }}</td>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('papeis.edit', ['id' => $papel->id]) }}"
